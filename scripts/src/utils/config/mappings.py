...
class ARGUMENTS:
    ...
    MAX_CANDIDATES_ANALYSIS = 'max_candidates_analysis'
    MIN_SOURCE_COUNT = 'min_source_count'
    PHYLOGENY_MIN_SEQUENCES = 'phylogeny_min_sequences'
    PHYLOGENY_MAX_PER_SPECIES = 'phylogeny_max_per_species'

    # Database coverage criteria
    DB_COV_TARGET_MIN_A = 'db_cov_target_min_a'
    DB_COV_TARGET_MIN_B = 'db_cov_target_min_b'
    ...
    FASTA_MIN_LENGTH = 'fasta_min_length'
    FASTA_MAX_LENGTH = 'fasta_max_length'
    ...
    FLAG_DETAILS_CSV = 'flag_details_csv'
...
CLI_ARGS = {
    ...
    ARGUMENTS.GBIF_MAX_OCCURRENCE_RECORDS: ('gbif_max_occurrence_records',),
